...
(
    ...
    authCode	 varchar2(30) default 'USER' not null,  --±ÇÇÑÄÚµå ADMIN, USER
    outdate		date        null,--Å»ÅðÀÎ °æ¿ì Å»ÅðÀÏ ³Ö´Â´Ù
    constraint member2_fk1 foreign key(authCode) references authority(authCode)
