			...
			$(".cfCodeLi").click(function(){
	    		...
	    		$.ajax({
	    			...
	    			success:function(data){
	    				...
	    				if(data.length >= 1){
		    				...
		    				$.each(data, function(index, items){
		    					...
		    					productListByFk+='<div class="email-list-item email-list-item--unread enterProduct">'
		                            ...
		                            +'</div>'
		                            +'<div class="email-list-detail"><span class="date float-right"><span class="icon"> </span>'+formatDate(items.productRegdate)+'</span><span class="from"> '+items.productName+' </span>'
	    				...
	    				$(".email-list").html(productListByFk);
                    ...
                    <div class="aside-content">
                        ...
                        <div class="aside-nav collapse">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="javascript:void(0)"><i class="m-r-10 mdi mdi-label text-secondary"></i>
                                    Important </a></li>
                                <li><a href="javascript:void(0)">
                                   <i class="m-r-10 mdi mdi-label text-primary"></i> Business   </a></li>
                                <li><a href="javascript:void(0)"> <i class="m-r-10 mdi mdi-label text-brand"></i>
                                   Inspiration </a></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="email-search">
                                    <div class="input-group input-search">
                                        <input class="form-control" type="text" placeholder="상품 검색하기"><span class="input-group-btn">
                    	...
                    	<c:if test="${!empty productList }">                    	
	                        <c:forEach var="productlist" items="${productList }">
	                        	<div class="email-list-item email-list-item--unread enterProduct">
		                            ...
		                            <div class="email-list-detail"><span class="date float-right"><span class="icon"> </span> <fmt:formatDate value="${productlist.productRegdate }" pattern="yyyy-MM-dd"/></span><span class="from"> ${productlist.productName } </span>
