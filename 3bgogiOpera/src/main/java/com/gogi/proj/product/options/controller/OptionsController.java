...
public class OptionsController {
	...
	@Transactional
	public String insertOptionsPost(@ModelAttribute OptionsVO optionVO ,@ModelAttribute OptionsCostsMatchingListVO optionsCostsMatchingVO){
		String msg = "";
		...
		int result = costDetailService.selectCostsPkByCostName(optionVO.getOptionPk(), optionsCostsMatchingVO);
